...
# directory.
#
410TESTS = getpid_test1 ck1 loader_test1 loader_test2 knife new_pages remove_pages_test1 remove_pages_test2 exec_basic exec_basic_helper exec_nonexist readline_basic sleep_test1 fork_wait fork_wait_bomb fork_exit_bomb actual_wait mem_permissions mem_eat_test make_crash make_crash_helper wait_getpid wild_test1 print_basic cho cho2 yield_desc_mkrun swexn_basic_test swexn_cookie_monster swexn_dispatch swexn_regs stack_test1 swexn_uninstall_test swexn_stands_for_swextensible cat cho_variant register_test minclone_mem
...
# directory.
#
STUDENTTESTS = test_exec1 test_readline test_sleep test_thr_create test_cyclone test_agility_drill test_paraguay test_startle test_div0
...
data_structures/ll.o data_structures/queue.o data_structures/circ_buffer.o data_structures/ht.o data_structures/stack.o  \
...
locks/mutex.o locks/sem.o locks/sched_mutex.o \
