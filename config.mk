...
#
KERNEL_OBJS = console.o kernel.o loader.o malloc_wrappers.o install_handlers.o handlers/syscall_handler_wrappers.o handlers/exception_handler_wrappers.o handlers/thr_mgmt_handlers.o handlers/exception_handlers.o virtual_mem_mgmt/page_directory.o virtual_mem_mgmt/frame_manager.o ll.o special_register_cntrl/cr_wrappers.o debug.o process_cntrl/pcb.o virtual_mem_mgmt/virtual_mem_manager.o virtual_mem_mgmt/mem_section.o
