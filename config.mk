...
#
KERNEL_OBJS = console.o kernel.o loader.o malloc_wrappers.o install_handlers.o handlers/syscall_handlers.o handlers/thr_mgmt_handlers.o handlers/exception_handlers.o virtual_mem_mgmt/page_directory.o virtual_mem_mgmt/frame_manager.o ll.o special_register_cntrl/cr_wrappers.o
