...
# directory.
#
410TESTS = getpid_test1 ck1 loader_test1 knife remove_pages_test1 remove_pages_test2 exec_basic exec_basic_helper exec_nonexist readline_basic sleep_test1 fork_wait fork_wait_bomb fork_exit_bomb actual_wait mem_permissions make_crash
...
# directory.
#
STUDENTTESTS = test_yield test_fork1 test_cs test_foo test_new_pages test_mem_mgmt test_exec1 test_deschedule test_readline test_sleep test_410yield
...
#
KERNEL_OBJS = console.o kernel.o loader/loader.o malloc_wrappers.o install_handlers.o debug.o asm_helpers.o \
